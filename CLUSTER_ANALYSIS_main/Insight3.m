% % 2023-01-25 L Martin added detailed description of the code

% % Insight3.m reads and writes .bin molecule lists generated with Insight3 software.
% % Used by FindClusters.m to read the input .bin files.

% % The following commented lines are examples of how using the different functionalities that this script contains
% % Just copy and paste the lines you need in the Command Window to:

% % 1) read a molecule list. Use the address of the .bin file you want to open.
% i3 = Insight3('D:/sample.bin');

% % 2) to access the data in the .bin molecule list just opened in 1)
% i3.data;

% % 3) or to create a copy of the opened .bin molecule list and use it as a new variable "mList"
% mList = i3.getData();

% % 4) Create a new molecule list with n random localizations for a pixels x pixels image. 
% % i.e. 1000 locs, 2 coordinates (x,y), 256px x 256 px.
% % The new .bin will be saved in the indicated directory with the name of "newMoleculeList.bin"
% i3 = Insight3();
% i3.setData( 256*rand(1000,2) );
% i3.write('D:/newMoleculeList.bin');

% % These are only some of the functions contained in Insight.m.
% % Others are: convertFormat, getNumberOfMolecules, getXY, getXYcorr, getXYZ, getXYZcorr, getChannels, getFrames, getPhotons, show, etc.
% % Each function's description is reported in details as commented (% %) inside the code.
